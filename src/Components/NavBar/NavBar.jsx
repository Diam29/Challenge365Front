...
//                 <Link to='/' className={styles.link__logo} onClick={() => window.location.reload()}>
//                     <BsFillPiggyBankFill  className={styles.rounded_pill}/>
//                     <span className={styles.navbar__text} >Challenge 365 Diamela Villalba</span>
//                 </Link>
//                 <div className={styles.button__icon} onClick={handleClick}>
//                     {user ? (
//                         userPhoto ? (
...
//                             <FaRegCircleUser className={styles.icon__inicio} onClick={handleClick} />
//                         </button>
//                     )}
//                 </div>
//             </div>
//             <div className={styles.display__login}>
//                 {showLoginFrom && <Login onClose={() => setShowLoginFrom(false)} onCloseForm={handleClose} />}
//             </div>
